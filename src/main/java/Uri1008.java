...
public class Uri1008 {
    ...
    public static void main(String[] args) {
        ...
        final int workedHours = scanner.nextInt();
        final double perHour = scanner.nextDouble();

        final double earned = workedHours * perHour;


        System.out.println(String.format("NUMBER = %d", employeeNumber));
        System.out.println(String.format("SALARY = U$ %.2f", earned));
    }
}
